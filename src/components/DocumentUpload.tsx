...
const DocumentUpload = ({ onUpload, onAnalysisComplete, companyReport }: DocumentUploadProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Upload Communication Document</CardTitle>
          <CardDescription>
            Upload marketing materials, press releases, or any communication content for greenwashing analysis
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div
          ...
          {isAnalyzing && (
            <div className="mt-4">
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>Analyzing document against EU & US guidelines...</span>
